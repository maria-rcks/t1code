...
export const AppTheme = Schema.Literals(["system", "light", "dark"]);
export type AppTheme = typeof AppTheme.Type;
export const DEFAULT_APP_THEME: AppTheme = "system";

export const AppThreadEnvMode = Schema.Literals(["local", "worktree"]);
export type AppThreadEnvMode = typeof AppThreadEnvMode.Type;
...
export const DEFAULT_AUTO_OPEN_PLAN_SIDEBAR = true;
...
export const AppSettingsSchema = Schema.Struct({
  theme: AppTheme.pipe(withDefaults(() => DEFAULT_APP_THEME)),
  ...
  autoOpenPlanSidebar: Schema.Boolean.pipe(withDefaults(() => DEFAULT_AUTO_OPEN_PLAN_SIDEBAR)),
...
export function resolveGitTextGenerationModel(settings: Pick<AppSettings, "textGenerationModel">) {
  return settings.textGenerationModel ?? DEFAULT_GIT_TEXT_GENERATION_MODEL;
}
