 ...
 *
 * Mirrors CodexDriver: create() returns one ProviderInstance bundling the
 * snapshot source, runtime adapter, and text-generation closures captured over
 * the per-instance ClaudeSettings.
 *
...
const DRIVER_KIND = Schema.decodeUnknownSync(ProviderDriverKind)("claudeAgent");
