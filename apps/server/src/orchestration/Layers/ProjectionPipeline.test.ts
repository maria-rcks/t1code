    ...
    it.effect("only creates pending approval rows for approval-requested activities", () =>
      Effect.gen(function* () {
        ...
        yield* eventStore.append({
          ...
          eventId: EventId.make("evt-user-input-requested"),
          aggregateKind: "thread",
          aggregateId: ThreadId.make("thread-pending-approval"),
          occurredAt: now,
          commandId: CommandId.make("cmd-user-input-requested"),
          causationEventId: null,
          correlationId: CommandId.make("cmd-user-input-requested"),
          metadata: {},
          payload: {
            threadId: ThreadId.make("thread-pending-approval"),
            activity: {
